...
| TD-017 | MEDIUM | Entitlements | **/bixosales sin `module:`** (RISK-013): el App Shell nuevo no exige entitlement; dos sistemas de modulo (project_modules vs ModulosPortal) | proxima | ABIERTA |
