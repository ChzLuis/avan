...
<div class="p-6">
    <div class="flex items-center justify-between mb-5">
        <div>
            ...
            <p class="text-xs text-gray-500">Flujos visuales que responden con la info real de tu negocio (catálogo, precios, IA).</p>
        </div>
        <a href="{{ route('bixocrm.bots.editor.new') }}"
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            @foreach($flows as $f)
                <a href="{{ route('bixocrm.bots.editor', $f->id) }}"
