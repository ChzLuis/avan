...
@php
    ...
    $pcVariantes = \App\Storefront\AgrupadorModelos::activoEn($project)
        ? app(\App\Storefront\AgrupadorModelos::class)->variantesDe($project, $p->id, $project->slug)
        : [];
    $pcNombre = $pcVariantes ? \App\Storefront\AgrupadorModelos::claveModelo($p) : $p->name;
    $pcData = [
        ...
        'color' => $pcVariantes ? \App\Storefront\AgrupadorModelos::colorActivo($pcVariantes, $pcImg) : null,
