...
@php
  ...
  $heroSub      = $settings['hero_sub']    ?? ($project->description ?? 'Lavado, planchado y prendas especiales con recojo a domicilio.');
  $heroBadge    = $settings['hero_badge']  ?? '';
  $heroBg       = $settings['hero_bg_color'] ?? '#EEF3F9';
  $footerTagline   = $settings['footer_tagline']   ?? 'Tu ropa en las mejores manos.';
...
<section class="py-10 border-b border-gray-100" data-store-native-section="benefits">
  <div class="max-w-7xl mx-auto px-6">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
      @foreach([
        ['🚚','Recojo y entrega','Gratis a domicilio'],
        ['⚡','Entrega rápida','En 24 a 48 horas'],
        ['✨','Prendas como nuevas','Cuidado profesional'],
        ['💧','Insumos premium','Hipoalergénicos'],
      ] as [$icon,$title,$sub])
