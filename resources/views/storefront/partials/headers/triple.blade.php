    ...
    <nav class="ht3-catbar" aria-label="Categorías y navegación" x-data="{ allOpen: false }" @click.outside="allOpen=false">
        <div class="ht3-catbar-inner">
            ...
            <div class="ht3-menu">
                ...
                @empty
                <a class="ht3-link {{ $activeDest === 'home' ? 'is-active' : '' }}" href="{{ \App\Support\StorefrontNavigation::resolveUrl($project, new \App\Models\StoreMenuItem(['destination_type' => 'home'])) }}">Inicio</a>
