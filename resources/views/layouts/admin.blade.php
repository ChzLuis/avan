        ...
        <nav class="flex-1 py-4 space-y-1 px-2 overflow-y-auto">
            @php
                $navItems = [
                    ...
                    ['route' => 'admin.licenses',   'icon' => 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z', 'label' => 'Licencias'],
