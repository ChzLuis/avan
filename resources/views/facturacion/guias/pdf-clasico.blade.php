...
<div class="gr">
      ...
      <tr>
        <td class="izq">
          <table class="gr-lista">
            ...
            <tr><td class="par" colspan="2">{{ \App\Support\Sunat\Catalogos::DOCUMENTOS_IDENTIDAD[$guia->destinatario_doc_tipo] ?? ($guia->destinatario_doc_tipo ?: 'R.U.C.') }}: <span class="val">{{ $guia->destinatario_doc_numero ?: '—' }}</span></td></tr>
          </table>
        </td>
        <td class="der2">
          @if($hayRuta)
  ...
  <div class="gr-cierre">
    <table class="gr-lista">
            ...
            <tr><td class="par" colspan="2">{{ \App\Support\Sunat\Catalogos::DOCUMENTOS_IDENTIDAD[$guia->conductor_doc_tipo] ?? ($guia->conductor_doc_tipo ?: 'DNI') }} del conductor: <span class="val">{{ $guia->conductor_doc_numero ?: '—' }}</span></td></tr>
