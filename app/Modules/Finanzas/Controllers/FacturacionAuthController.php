...
class FacturacionAuthController extends Controller
{
    public function showLoginGeneral()
    {
        ...
        return view('finanzas::facturacion.login-general', ['projects' => collect()]);
    }
    ...
    public function loginGeneral(Request $request)
    {
        ...
        return view('finanzas::facturacion.login-general', [
            'projects' => $projects,
    ...
    public function showLogin(string $slug)
    {
        ...
        return view('finanzas::facturacion.login', compact('project'));
    }
