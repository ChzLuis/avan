...
use App\Modules\Finanzas\Models\Certificado;
...
class CertificadoController extends Controller
{
    public function index()
    {
        ...
        return view('finanzas::certificados.index', compact('project', 'certificados'));
    }
    ...
    public function verificar(string $codigo)
    {
        ...
        return view('finanzas::certificados.verificar', compact('cert'));
    }
}
