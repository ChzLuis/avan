@php
    ...
    $qrDatos = implode('|', [
        ...
        \App\Modules\Finanzas\Support\Sunat\Catalogos::codigoDocumentoIdentidad($invoice->client_doc_type, $invoice->client_doc_number),
        $invoice->client_doc_number ?: '-',
        $invoice->sunat_hash ?: '',
    ]);

    $enLetras = \App\Modules\Finanzas\Support\Sunat\MontoEnLetras::de((float) $invoice->total, $invoice->currency);
