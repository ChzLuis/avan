...
@include('finanzas::invoices._formulario')
...
@if($lectorActivo ?? false)
@include('finanzas::invoices._lector')
@endif
</div>
...
function invoicesApp() {
    return {
        ...
        motivosCredito: @json(\App\Modules\Finanzas\Support\Sunat\Catalogos::MOTIVOS_NOTA_CREDITO),
        motivosDebito:  @json(\App\Modules\Finanzas\Support\Sunat\Catalogos::MOTIVOS_NOTA_DEBITO),
