...
namespace App\Modules\Catalogo\Conectores\Sync;
...
use App\Modules\Catalogo\Conectores\Enums\ItemEntityType;
use App\Modules\Catalogo\Conectores\Enums\ItemSyncStatus;
use App\Modules\Catalogo\Conectores\Enums\SyncMode;
use App\Modules\Catalogo\Conectores\Enums\SyncStatus;
use App\Modules\Catalogo\Conectores\Enums\SyncTrigger;
use App\Modules\Catalogo\Conectores\Exceptions\CatalogProviderException;
use App\Modules\Catalogo\Conectores\Registry\CatalogProviderRegistry;
use App\Modules\Catalogo\Models\CatalogIntegration;
use App\Modules\Catalogo\Models\CatalogIntegrationItem;
use App\Modules\Catalogo\Models\CatalogSyncRun;
...
class CatalogSyncManager
{
    ...
    /** @param callable(\App\Modules\Catalogo\Conectores\DTOs\SyncCursor): \App\Modules\Catalogo\Conectores\DTOs\EntityPage $fetchPage */
    private function syncEntities(
        ...
        $cursor = \App\Modules\Catalogo\Conectores\DTOs\SyncCursor::start();
    ...
    private function upsertOne(CatalogIntegration $integration, ItemEntityType $type, NormalizedProduct|\App\Modules\Catalogo\Conectores\DTOs\NormalizedService $normalized, CatalogSyncRun $run): void
    {
