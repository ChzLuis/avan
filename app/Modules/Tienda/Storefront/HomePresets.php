 ...
 *   · una PIEL de CSS (`app/Modules/Tienda/Views/components/storefront-home-skins`)
...
final class HomePresets
{
    ...
    public static function ordenar(\Illuminate\Support\Collection $secciones, mixed $clave): \Illuminate\Support\Collection
    {
        ...
        $registro = array_flip(array_keys(\App\Modules\Tienda\Support\StorefrontSections::COMPONENTS));
        $cola = count($orden);
