...
@php
    ...
    $ftLegalName = \App\Modules\Tienda\Storefront\DatosPie::legal($settings ?? [], $project)['nombre'];
        ...
        <div class="ftc-bottom-inner">
            ...
            <div class="ftc-secure">
                <span class="ftc-seals">
                    @if($ftcSecureStyle !== 'https')@include('tienda::storefront.partials.badges.ssl-seal', ['sealStyle' => 'gold', 'sealPx' => 44])@endif
                    @if($ftcSecureStyle !== 'gold')@include('tienda::storefront.partials.badges.ssl-seal', ['sealStyle' => 'https', 'sealPx' => 44])@endif
                </span>
            ...
            <div class="ftc-pays">@include('tienda::storefront.partials.badges.pay-logos', ['pay' => $ftcPay])</div>
            @endif
        </div>
    </div>
</footer>
