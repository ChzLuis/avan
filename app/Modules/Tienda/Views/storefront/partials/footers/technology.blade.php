        ...
        <div class="ftt-bottom-inner">
            ...
            <div class="ftt-secure">
                ...
                <span class="ftt-seals">
                    @if($ftSecureStyle !== 'https')@include('tienda::storefront.partials.badges.ssl-seal', ['sealStyle' => 'gold', 'sealPx' => 50])@endif
                    @if($ftSecureStyle !== 'gold')@include('tienda::storefront.partials.badges.ssl-seal', ['sealStyle' => 'https', 'sealPx' => 50])@endif
                </span>
                @endif
            ...
            <div class="ftt-pays">@include('tienda::storefront.partials.badges.pay-logos', ['pay' => $ftPay])</div>
            @endif
        </div>
    </div>
</footer>
