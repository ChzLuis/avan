...
<div class="header-zone hdr-centered {{ $headerStickyMode !== 'none' ? 'is-sticky' : '' }}">
    <header>
        <div class="hdc-top">
            ...
            <a class="hdc-brand" href="{{ \App\Modules\Tienda\Support\StorefrontNavigation::resolveUrl($project, new \App\Modules\Tienda\Models\StoreMenuItem(['destination_type' => 'home'])) }}">
        ...
        <nav class="hdc-nav" aria-label="Navegación principal" x-data="{ catsOpen: false }" @click.outside="catsOpen=false">
            ...
            @empty
            <a class="hdc-link {{ $activeDest === 'home' ? 'is-active' : '' }}" href="{{ \App\Modules\Tienda\Support\StorefrontNavigation::resolveUrl($project, new \App\Modules\Tienda\Models\StoreMenuItem(['destination_type' => 'home'])) }}">Inicio</a>
