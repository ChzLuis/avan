...
<div class="hba">
    ...
    <header class="hba-main">
        ...
        <a class="hba-brand" href="{{ \App\Modules\Tienda\Support\StorefrontNavigation::resolveUrl($project, new \App\Modules\Tienda\Models\StoreMenuItem(['destination_type' => 'home'])) }}">
    ...
    <nav class="hba-nav" aria-label="Navegación principal" x-data="{ catsOpen: {{ request('abrir') === 'categorias' ? 'true' : 'false' }} }" @mouseleave="catsOpen=false" @click.outside="catsOpen=false">
        ...
        <div class="hba-nav-in{{ $hbaModo !== 'none' && $hbaCatsPos === 'izquierda' ? ' has-cats-left' : '' }}">
            ...
            @if($hbaModo !== 'none' && $hbaCatsPos === 'izquierda')
                @include('tienda::storefront.partials.nav.cats-button', ['modo' => $hbaModo, 'pos' => $hbaCatsPos, 'var' => 'catsOpen'])
            @endif
            ...
            @empty
            <a class="hba-link {{ $activeDest === 'home' ? 'is-active' : '' }}" href="{{ \App\Modules\Tienda\Support\StorefrontNavigation::resolveUrl($project, new \App\Modules\Tienda\Models\StoreMenuItem(['destination_type' => 'home'])) }}">Inicio</a>
        ...
        @if($hbaMega)
            @include('tienda::storefront.partials.nav.mega-catalogo')
        @endif
    </nav>
</div>
