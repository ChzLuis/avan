...
@php
  ...
  // Misma serializacion que consume el catalogo: ver App\Modules\Tienda\Storefront\VariantPresenter.
  $realVariants = \App\Modules\Tienda\Storefront\VariantPresenter::forProduct(
      $product,
      $imgUrl($mainImg),
