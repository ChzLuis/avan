...
// proyecto, ignorando lo que el comerciante corrige en el Constructor. Misma
// cadena de resolucion que el resto de la plantilla.
  ...
  <div class="page">
    ...
    <div class="footer-base">
      @php
          ...
          $ecLegal = \App\Modules\Tienda\Storefront\DatosPie::legal($settings ?? [], $project);
          $ecVerLegal = (string) (($settings ?? [])['footer_show_legal'] ?? '1') !== '0'
              && ($ecLegal['nombre'] !== '' || $ecLegal['ruc'] !== '');
          $ecTextoLegal = trim($ecLegal['nombre'].($ecLegal['ruc'] ? ' · RUC '.$ecLegal['ruc'] : ''), ' ·');
      @endphp
      <span>{{ $footerCopyright }}@if($ecVerLegal) · {{ $ecTextoLegal }}@endif · Desarrollado por <a href="https://eskalagroup.com/" target="_blank" rel="noopener" style="color:inherit;font-weight:700;text-decoration:underline">Eskala</a></span>
