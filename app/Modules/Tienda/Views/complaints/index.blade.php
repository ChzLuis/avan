...
<div class="lr-wrap">
    ...
    <div class="lr-head">
        <div>
            ...
            <p class="lr-sub">
                Lo que registran tus clientes en tu tienda. INDECOPI da {{ \App\Modules\Tienda\Controllers\ComplaintController::PLAZO_HABILES }} días hábiles para responder cada uno.
            </p>
        </div>
    ...
    <div class="lr-card">
        ...
        <table class="lr-tabla">
            ...
            @foreach($complaints as $c)
                @php
                    $vence = \App\Modules\Tienda\Controllers\ComplaintController::vence($c);
