<x-app-layout>
@include('tienda::settings.builder.styles')
...
<div class="bx-builder" x-data="builderApp(@js([
    ...
    @include('tienda::settings.builder.topbar')

    <div class="bxb-body">
        @include('tienda::settings.builder.stage-nav')

        {{-- Panel central: SOLO la tarea actual --}}
        <main class="bxb-panel" aria-live="polite">
            <template x-if="stage==='business'">
                @include('tienda::settings.builder.stages.business')
            </template>
            ...
            <div x-show="stage==='appearance'" x-cloak>
                @include('tienda::settings.builder.stages.appearance')
            </div>
            ...
            <div x-show="stage==='header'" x-cloak>
                @include('tienda::settings.builder.stages.header')
            </div>

            <template x-if="stage==='home'">
                @include('tienda::settings.builder.stages.home')
            </template>

            <template x-if="stage==='catalog'">
                @include('tienda::settings.builder.stages.catalog')
            </template>

            {{-- x-show (no x-if): los formularios embebidos enlazan listeners en DOMContentLoaded. --}}
            <div x-show="stage==='pages'" x-cloak>
                @include('tienda::settings.builder.stages.pages')
            </div>

            <template x-if="stage==='sales'">
                @include('tienda::settings.builder.stages.sales')
            </template>

            <div x-show="stage==='legal'" x-cloak>
                @include('tienda::settings.builder.stages.legal')
            </div>

            <template x-if="stage==='advanced'">
                @include('tienda::settings.builder.advanced')
            </template>
        ...
        @include('tienda::settings.builder.preview')
    </div>
...
@include('tienda::settings.builder.script')
@include('tienda::settings.builder.partials.image-template-script')
</x-app-layout>
