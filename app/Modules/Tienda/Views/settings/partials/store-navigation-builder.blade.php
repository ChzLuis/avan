    ...
    <div class="snb-card">
        ...
        <div class="snb-menu-list" data-menu-sort-list data-parent="">
            @forelse($roots as $item)
                @include('tienda::settings.partials.store-menu-item', ['item'=>$item])
                @if($item->children->isNotEmpty())
                    <div class="snb-submenu" data-menu-sort-list data-parent="{{ $item->id }}">@foreach($item->children as $child)@include('tienda::settings.partials.store-menu-item', ['item'=>$child])@endforeach</div>
                @endif
