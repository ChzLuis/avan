...
use App\Modules\Tienda\Models\DesignTemplate;
use App\Modules\Tienda\Storefront\DesignTemplateService;
...
class DesignTemplateController extends Controller
{
    ...
    private function activeProject(): \App\Models\Project
    {
        ...
        abort_unless(\App\Modules\Tienda\Storefront\BuilderAccess::allows($project, auth()->user()), 403);
        return $project;
    }
    ...
    public function index()
    {
        ...
        return view('tienda::settings.design-templates', [
            'templates' => $templates,
            'archived' => $archived,
