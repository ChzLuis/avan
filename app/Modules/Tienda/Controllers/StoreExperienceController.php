...
use App\Modules\Tienda\Storefront\StoreSectionWriteService;
use App\Modules\Tienda\Storefront\StorePageWriteService;
use App\Modules\Tienda\Storefront\StorePopupWriteService;
...
class StoreExperienceController extends Controller
{
    ...
    {
        $project = $this->project();
        return app(TiendaPublicaController::class)->previewStorefront($project);
    }
    ...
    public function page(Request $request)
    {
        ...
        $existingContent = \App\Modules\Tienda\Models\StorePage::where('project_id', $project->id)
    ...
    {
        $complaint = $this->project()->hasMany(\App\Modules\Tienda\Models\Complaint::class)->findOrFail($id);
