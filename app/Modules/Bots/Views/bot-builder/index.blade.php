...
@php
$bots   = \App\Modules\Bots\Models\BotInstance::where('project_id', $activeProject->id)->get();
...
<div x-show="activeTab==='bots'" class="flex-1 overflow-y-auto p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 max-w-6xl mx-auto">
        ...
        @php
            ...
            $sessCount = \App\Modules\Bots\Models\BotSession::whereHas('flow', fn($q)=>$q->where('bot_type',$bot->bot_type))
