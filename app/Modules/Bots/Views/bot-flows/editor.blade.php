<x-portal-layout layout="panel" :project="$project" pageTitle="Constructor de bot">
...
<script>
  window.__botFlow = {
    ...
    esComercial: @json($flow->plantilla === \App\Modules\Bots\Models\BotFlow::COMERCIAL),
...
<div x-data="botEditor(window.__botFlow)" class="flex w-full" style="height:calc(100vh - 56px); background:#fff; position:relative;">
    ...
    <div class="w-52 flex-shrink-0 border-r border-gray-200 bg-gray-50 overflow-y-auto p-3">
        ...
        <div class="mt-4 pt-3 border-t border-gray-100 space-y-2">
            ...
            <button @click="openReglas=true" class="w-full text-xs font-semibold text-indigo-700 bg-indigo-50 hover:bg-indigo-100 rounded-lg py-2">⚙ Disparos y Reglas</button>
        </div>
    </div>
