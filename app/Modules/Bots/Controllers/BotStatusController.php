...
use App\Modules\Bots\Models\BotState;
use App\Modules\Bots\Models\BotTransition;
use App\Modules\Bots\Models\BotConfig;
...
class BotStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bots::bots.index', compact('project', 'bots'));
    }
    ...
    public function flowIndex(Request $request)
    {
        ...
        return view('bots::bots.flow', compact('project', 'flow', 'allStates', 'botType'));
    }
