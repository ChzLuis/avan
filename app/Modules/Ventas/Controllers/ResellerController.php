...
use App\Modules\Ventas\Models\ResellerPrice;
use App\Models\User;
...
class ResellerController extends Controller
{
    ...
    public function misPrecios()
    {
        ...
        return view('ventas::reseller.precios', compact('project', 'productos', 'enlace', 'rutaGuardar', 'rutaToggle', 'rutaPos', 'portalLayout'));
    }
