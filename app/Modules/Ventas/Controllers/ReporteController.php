...
class ReporteController extends Controller
{
    ...
    public function topProductos(Request $request)
    {
        ...
        return view('ventas::comercial.reportes.top-productos', compact('project', 'top', 'desde', 'hasta'));
    }
    ...
    public function ventas(Request $request)
    {
        ...
        return view('ventas::comercial.reportes.ventas', compact(
    ...
    public function rentabilidad(Request $request)
    {
        ...
        return view('ventas::comercial.reportes.rentabilidad', compact(
    ...
    public function inventario()
    {
        ...
        return view('ventas::comercial.reportes.inventario', compact('project', 'products', 'pageTitle'));
    }
