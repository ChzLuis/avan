...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        $lectorActivo = \App\Support\Lector\LectorComprobantes::disponible($project);
    ...
    private function calcularLineas(array $items, bool $igvIncluded): array
    {
        ...
        foreach ($data['items'] as $item) {
            ...
            $itemsData[] = [
                ...
                'unit'        => \App\Support\Sunat\Catalogos::codigoUnidad($item['unit'] ?? 'NIU'),
                'quantity'    => $qty,
                'unit_price'  => $precio,
                'discount'    => $descuento,
    ...
    private function descargarArchivo(Invoice $invoice, string $cual)
    {
        ...
        \App\Support\Sunat\ArchivoComprobantes::asegurar($invoice);
        $ruta  = $cual === 'xml'
            ? \App\Support\Sunat\ArchivoComprobantes::rutaXml($invoice)
            : \App\Support\Sunat\ArchivoComprobantes::rutaCdr($invoice);
        $disco = \Illuminate\Support\Facades\Storage::disk(\App\Support\Sunat\ArchivoComprobantes::DISCO);
