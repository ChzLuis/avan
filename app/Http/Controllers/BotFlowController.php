...
class BotFlowController extends Controller
{
    public function index()
    {
        ...
        $checklistComercial = \App\Support\FlowEngine\PlantillaComercial::checklist($project);
        $iaLicenciada = \App\Ia\InterpreteComercial::licenciado($project);
        $iaActiva     = \App\Ia\InterpreteComercial::activo($project);
        return view('bot-flows.index', compact('project', 'flows', 'checklistComercial', 'iaLicenciada', 'iaActiva'));
    }
